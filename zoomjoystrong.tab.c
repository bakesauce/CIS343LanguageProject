...
{
  "$end", "error", "$undefined", "INT", "FLOAT", "END", "POINT", "LINE",
  "CIRCLE", "RECTANGLE", "SET_COLOR", "END_STATEMENT", "$accept",
  "program", "list_of_expr", "expr", "value", YY_NULLPTR
};
#endif
...
{
       0,     6,     7,     8,     9,    10,    11,    13,    14,    15,
       3,     4,    16,    16,    16,    16,    16,     0,    15,    16,
